"""
Django settings for adoption_pet project.
...
# Opción opcional: actualizar el tiempo de expiración en cada petición
...
SECRET_KEY = 'django-insecure-tg1_@6j2$1ienkkh)0^-&q+rwr7gqfbday$g$#bhn_g@b3u@fd'
...
# URL base para acceder a los archivos en templates
MEDIA_URL = '/media/'
